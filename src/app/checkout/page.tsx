...
const plans = {
    "mc-starter": {
        ...
        name: "MC Starter",
        price: 149,
        features: ["2 GB RAM", "1 vCPU", "SSD Storage"],
    },
    "mc-10-day": {
        id: "mc-10-day",
        type: "minecraft",
    ...
    "mc-pro": {
        ...
        name: "MC Pro",
        price: 249,
        features: ["4 GB RAM", "2 vCPU", "SSD Storage"],
    },
    "mc-elite": {
        id: "mc-elite",
        type: "minecraft",
        name: "MC Elite",
        price: 399,
        features: ["8 GB RAM", "4 vCPU", "SSD/NVMe Storage"],
    },
    "vps-starter": {
        id: "vps-starter",
        type: "vps",
    ...
    "vps-basic": {
        ...
        name: "VPS Basic",
        price: 599,
        features: ["2 vCPU", "4 GB RAM", "40 GB SSD"],
    },
    "vps-pro": {
        id: "vps-pro",
        type: "vps",
        name: "VPS Pro",
        price: 899,
        features: ["4 vCPU", "8 GB RAM", "80 GB SSD"],
    },
    "vps-enterprise": {
        id: "vps-enterprise",
        type: "vps",
        name: "VPS Enterprise",
        price: 1299,
        features: ["8 vCPU", "16 GB RAM", "160 GB SSD"],
    },
};
...
const addonOptions: Record<string, AddonOption[]> = {
    ...
    vps: [
        ...
        },
        {
            id: "subdomain",
            name: "Subdomain",
            description: "Get a free .vecrahost.in subdomain (₹99/year)",
            pricePerUnit: 99,
            unit: "toggle",
        },
    ],
...
function CheckoutContent() {
    ...
    const [term, setTerm] = useState<1 | 12 | 24>(1);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <section className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 lg:p-8 shadow-lg">
                            ...
                            <div className="mb-6">
                                ...
                                {selectedPlan.id === "mc-10-day" ? (
                                    ...
                                    <select
                                        value={term}
                                        onChange={(e) => setTerm(parseInt(e.target.value) as 1 | 12 | 24)}
                                    ...
                                    >
                                        ...
                                        <option value={12}>1 Year - ₹{Math.round(base * 12 * 0.85)} (15% off)</option>
                                        <option value={24}>2 Years - ₹{Math.round(base * 24 * 0.75)} (25% off)</option>
                                    </select>
                                )}
                            </div>
                        </section>
                    ...
                    <aside className="lg:sticky lg:top-8 lg:h-fit">
                        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 lg:p-8 shadow-lg">
                            ...
                            {/* Discord Community Option */}
                            <div className="mt-6 p-4 bg-indigo-600/10 border border-indigo-500/30 rounded-lg text-center">
                                <div className="flex items-center justify-center mb-3">
                                    ...
                                    <h4 className="font-semibold text-white">Better  Experience</h4>
                                </div>
                                <p className="text-gray-300 text-sm mb-3">
                                    Join our Discord community for instant support, gaming tips, and exclusive events. No login required!
                                </p>
                                <a
                                    href={DISCORD_INVITE_LINK}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-block px-4 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200 text-sm"
                                >
